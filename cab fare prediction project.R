rm(list=ls())
setwd("E:/MSK/Data Science/Edwisor data science/Project")
getwd()
...
# mae        mse       rmse       mape 
#0.17305002 0.07374978 0.27156911 0.07595965 
# decision tree
mape(Test[,1],predictions_tree)
# 8.391105
regr.eval(Test[,1],predictions_tree)
#mae        mse       rmse       mape 
#0.19094109 0.07439311 0.27275100 0.08391105 
...
#mae        mse       rmse       mape 
#0.21793423 0.08845274 0.29741005 0.09705725
